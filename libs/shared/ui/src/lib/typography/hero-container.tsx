...
export const HeroContainer: React.FC<HeroContainerProps> = (props: HeroContainerProps) => {
    const { disableMobileHidden, disableTabExclusion = false, left, linearGradient, right, rightSx } = props;
            ...
            <Box sx={{ overflow: 'hidden' }}>
                ...
                >
                    <Grid container sx={{ alignItems: 'center', height: '100%', mx: 'auto' }}>
                        ...
                        <Grid size={{ xs: 12, md: 5, lg: 6 }} sx={{ maxHeight: '100%' }}>
                            {renderRightWrapper({
                                height: {
                                    xs: 'initial',
                                    md: 'calc(100vh - 120px)',
        ...
        <Box sx={{ overflow: 'hidden' }}>
            ...
            >
                <Grid container sx={{ alignItems: 'center', flexWrap: 'nowrap', height: '100%', mx: 'auto' }}>
                    <Grid size={{ md: 7, lg: 6 }} sx={{ m: 'auto' }}>
                        {left}
                    </Grid>
                    <Grid size={{ md: 5, lg: 6 }} sx={{ maxHeight: '100%', display: { xs: 'none', md: 'initial' } }}>
                        {renderRightWrapper()}
                    </Grid>
                </Grid>
            </Container>
