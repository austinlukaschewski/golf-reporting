...
export const getDesignTokens = (mode: 'light' | 'dark') =>
    ({
        palette: {
            ...
            custom: {
                efxRed: 'hsl(349, 71%, 36%)',
                efxGrey: 'hsl(209, 17%, 24%)',
            },
            text: {
                ...(mode === 'light' && {
                    primary: grey[900],
        ...
        spacing: 8,
        typography: {
            fontFamily: ['"Inter"', '"Inter Tight"', ...systemFont].join(','),
            // Match VS Code
            ...
            fontFamilyTagline: ['"Inter Tight"', ...systemFont].join(','),
            fontFamilySystem: systemFont.join(','),
            fontWeightSemiBold: 600,
            fontWeightExtraBold: 800,
            h1: {
                fontFamily: ['"Inter Tight"', ...systemFont].join(','),
                    ...
                    root: ({ theme, ownerState }) => ({
                        ...
                        ...(ownerState.variant === 'outlined' &&
                            ownerState.color === 'secondary' && {
                                ...
                                boxShadow: `#FFF 0 1px 0 1px inset, ${alpha(
                                    theme.palette.grey[200],
                                    0.4,
                                )} 0 -1px 0 1px inset, ${alpha(theme.palette.grey[200], 0.5)} 0 1px 2px 0`,
                                '&:hover': {
                                ...
                                ...theme.applyDarkStyles({
                                    ...
                                    boxShadow: `${alpha(theme.palette.primaryDark[700], 0.3)} 0 1px 0 1px inset, ${
                                        (theme.vars || theme).palette.common.black
                                    } 0 -1px 0 1px inset, ${(theme.vars || theme).palette.common.black} 0 1px 2px 0`,
                                    '&:hover': {
                        ...
                        ...(ownerState.variant === 'outlined' &&
                            ownerState.color === 'primary' && {
                                ...
                                boxShadow: `${alpha(theme.palette.primary[100], 0.4)} 0 -1px 0 1px inset, ${alpha(
                                ...
                                ...theme.applyDarkStyles({
                                    ...
                                    boxShadow: `${alpha(theme.palette.primary[900], 0.2)} 0 1px 0 1px inset, ${
                                        (theme.vars || theme).palette.common.black
                                    } 0 -1px 0 1px inset, ${(theme.vars || theme).palette.common.black} 0 1px 2px 0`,
                                    '&:hover': {
                        ...
                        ...(ownerState.variant === 'contained' &&
                            ownerState.color === 'primary' && {
                                ...
                                boxShadow: `${alpha(theme.palette.primary[400], 0.5)} 0 1px 0 inset, ${alpha(
                                    theme.palette.primary[800],
                                    0.4,
                                )} 0 -1px 0 1px inset, ${alpha(theme.palette.common.black, 0.1)} 0 2px 4px 0`,
                                '&:hover': {
                        ...
                        ...(ownerState.variant === 'contained' &&
                            ownerState.color === 'secondary' && {
                                ...
                                border: '1px solid ',
                                borderColor: (theme.vars || theme).palette.primaryDark[600],
                                boxShadow: `${alpha(theme.palette.primaryDark[400], 0.5)} 0 1px 0 1px inset, ${alpha(
                        ...
                        style: ({ theme }) => [
                            {
                                ...
                                boxShadow: `#FFF 0 1px 0 inset, ${alpha(
                                    theme.palette.grey[200],
                                    0.4,
                            ...
                            theme.applyDarkStyles({
                                ...
                                borderColor: alpha(theme.palette.primaryDark[600], 0.5),
                                backgroundColor: alpha(theme.palette.primaryDark[700], 0.2),
                                boxShadow: `${alpha(theme.palette.primaryDark[600], 0.3)} 0 1px 0 inset, ${
                                    (theme.vars || theme).palette.common.black
                    ...
                    root: ({ theme, ownerState }) => [
                        {
                            ...
                            ...(ownerState.variant === 'outlined' && {
                                ...
                                '&[href]': {
                                    textDecorationLine: 'none',
                                    boxShadow: `hsl(200, 0%, 100%) 0 2px 0 inset, ${alpha(
                        ...
                        theme.applyDarkStyles({
                            ...
                            ...(ownerState.variant === 'outlined' && {
                                ...
                                '&[href]': {
                                    textDecorationLine: 'none',
                                    boxShadow: `${alpha(theme.palette.primaryDark[700], 0.4)} 0 2px 0 inset, ${
                                        (theme.vars || theme).palette.common.black
                                    } 0 -2px 0 inset, ${(theme.vars || theme).palette.common.black} 0 1px 2px 0`,
                                    '&:hover': {
                ...
                styleOverrides: {
                    root: ({ theme, ownerState }) => ({
                        ...(ownerState.variant === 'elevation' && {
                            border: '1px solid',
                            borderColor: (theme.vars || theme).palette.grey[100],
                            boxShadow: `${alpha(theme.palette.grey[200], 0.4)} 0 -1px 0 inset, ${alpha(
                                theme.palette.grey[300],
                                0.5,
                            )} 0 1px 8px 0`,
                            ...theme.applyDarkStyles({
                                borderColor: (theme.vars || theme).palette.primaryDark[700],
                                boxShadow: `${(theme.vars || theme).palette.common.black} 0 -1px 0 inset, ${
                                    (theme.vars || theme).palette.common.black
                                } 0 1px 8px 0`,
                            }),
                        }),
